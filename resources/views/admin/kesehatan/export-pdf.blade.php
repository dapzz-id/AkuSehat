...
<head>
    ...
    <style>
        ...
        .badge-bmi-normal { background-color: #c8e6c9; color: #1b5e20; }
        .badge-bmi-underweight { background-color: #fff9c4; color: #f57f17; }
        .badge-bmi-overweight { background-color: #ffe0b2; color: #ef6c00; }
        .badge-bmi-obesitas-level-1 { background-color: #ffcdd2; color: #c62828; }
        .badge-bmi-obesitas-level-2 { background-color: #f44336; color: #ffffff; }
        .badge-bmi-obesitas-level-3 { background-color: #b71c1c; color: #ffffff;}

        .badge-tkd-normal { background-color: #c8e6c9; color: #1b5e20; }
        .badge-tkd-elevasi { background-color: #fff9c4; color: #f57f17; }
        .badge-tkd-hipertensi-tahap-1 { background-color: #ffe0b2; color: #ef6c00; }
        .badge-tkd-hipertensi-tahap-2 { background-color: #ffcdd2; color: #c62828; }
        .badge-tkd-krisis { background-color: #b71c1c; color: #ffffff; }
        .badge-tkd-hipotensi { background-color: #bbdefb; color: #0d47a1;}
...
<body>
    ...
    <div style="text-align:center; margin-top: 0px; margin-bottom: 4px;">
        <h3 style="margin: 0;">DATA KESEHATAN {{ $namaSekolah }}</h3>
