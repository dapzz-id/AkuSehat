...
<div class="space-y-6">
    ...
    <div class="bg-white shadow-sm rounded-lg">
        <form action="{{ route('admin.kesehatan.update', $kesehatan->id_kesehatan) }}" method="POST" class="p-6 space-y-6">
            @csrf
            @method('PUT')
                ...
                <div class="flex">
                    ...
                    <div class="ml-3">
                        ...
                        <div class="mt-2 text-sm text-yellow-700 grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <div>
                                <p><strong>Tekanan Darah:</strong> {{ $kesehatan->sistol }}/{{ $kesehatan->diastol }}</p>
