...
<body class="bg-gradient-to-br from-blue-50 via-white to-indigo-100 min-h-screen flex items-center justify-center px-4 py-8">
            ...
            <div class="p-8 mobile-padding">
                ...
                <form action="{{ route('login') }}" method="POST" class="space-y-6 mobile-margin">
                    ...
                    <div class="flex items-center justify-between mt-2">
                        <div class="flex items-center">
                            <input id="remember-me" name="remember-me" type="checkbox" class="h-4 w-4 text-[#1B5E20] focus:ring-[#308a34] border-gray-300 rounded">
                            <label for="remember-me" class="ml-2 block text-sm text-gray-700">Ingat saya</label>
                        </div>
                        
                        <div class="text-sm">
                            <a href="#" class="font-medium text-[#1B5E20] hover:text-[#308a34] transition-colors">Lupa password?</a>
                        </div>
                    </div>
    ...
    <script>
        // Animasi untuk elemen error jika ada
